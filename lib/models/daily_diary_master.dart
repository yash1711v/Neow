class DailyDiaryMaster {
  DailyDiaryData? _data;
  bool? _success;
  String? _message;

  DailyDiaryMaster({DailyDiaryData? data, bool? success, String? message}) {
    if (data != null) {
      _data = data;
    }
    if (success != null) {
  ...
  DailyDiaryData? get data => _data;
  set data(DailyDiaryData? data) => _data = data;
  bool? get success => _success;
  set success(bool? success) => _success = success;
  String? get message => _message;
  set message(String? message) => _message = message;

  DailyDiaryMaster.fromJson(Map<String, dynamic> json) {
    _data =
        json['data'] != null ? DailyDiaryData.fromJson(json['data']) : null;
...
class DailyDiaryData {
  ...
  set toDoList(List<String>? toDoList) => _toDoList = toDoList;
  List<String>? get dailyDairy => _dailyDairy;
  set dailyDairy(List<String>? dailyDairy) => _dailyDairy = dailyDairy;
  String? get isEdit => _isEdit;
  set isEdit(String? isEdit) => _isEdit = isEdit;
  String? get createdAt => _createdAt;
  set createdAt(String? createdAt) => _createdAt = createdAt;

  DailyDiaryData.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
    ...
    _food = json['food'];
    _edit = json['edit'];
    _toDoList = json['to_do_list'].cast<String>();
    _dailyDairy = json['daily_dairy'].cast<String>();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['food'] = _food;
    data['edit'] = _edit;
    data['to_do_list'] = _toDoList;
    data['daily_dairy'] = _dailyDairy;
