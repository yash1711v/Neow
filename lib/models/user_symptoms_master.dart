class UserSymptomsMaster {
  ...
  UserSymptomsMaster({SymptomsData? data, bool? success, String? message}) {
    if (data != null) {
      _data = data;
    }
    if (success != null) {
  ...
  SymptomsData? get data => _data;
  set data(SymptomsData? data) => _data = data;
  bool? get success => _success;
  set success(bool? success) => _success = success;
  String? get message => _message;
  set message(String? message) => _message = message;

  UserSymptomsMaster.fromJson(Map<String, dynamic> json) {
    _data =
        json['data'] != null ? SymptomsData.fromJson(json['data']) : null;
